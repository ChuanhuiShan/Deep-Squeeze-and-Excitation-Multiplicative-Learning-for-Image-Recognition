...
def inference(images, batch_size, n_classes):
    ...
    #######################################################
    with tf.variable_scope('SE_M') as scope:
        glob_pool1 = tf.reduce_mean(norm1, [1, 2], name='global_pool', keep_dims=True) # Global pooling
        ...
        h_conv5 = tf.multiply(conv4, tf.multiply(norm1, Se_fc2_tensor1)) 
...
##                          beta=0.75,name='norm2')
        pool6 = tf.nn.max_pool(h_conv5, ksize=[1,3,3,1], strides=[1,2,2,1],
